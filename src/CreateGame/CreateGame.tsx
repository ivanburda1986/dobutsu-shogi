...
import { createGame, joinGame } from "../api/firestore";
...
export const CreateGame: FC = () => {
  ...
  return (
    <Container className="text-success">
      ...
      <Container
        fluid
        className={`py-3 my-1 border-rounded-lightblue transparentContainer`}
      >
        <Row>
          <Form>
            ...
            <Button
              ...
              onClick={() =>
                createGame({
                  ...
                  createGameCb: {
                    join: joinGameUponCreation,
                    redirect: navigateToLaunchScreen,
                  },
                })
              }
            >
