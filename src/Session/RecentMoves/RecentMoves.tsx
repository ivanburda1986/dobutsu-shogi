...
export const RecentMoves: FunctionComponent<RecentMovesInterface> = ({moves = []}) => {
    ...
    if (!lastMove) {
        return (<div className={`${styles.OpponentBg}  d-flex justify-content-center align-items-center m`}>
        ...
        return (
            <div className={`d-flex justify-content-center align-items-center m`}>
                ...
                {
                    lastMove.isTakeOver && <div className={styles.OpponentBg}>
                ...
                <div className={styles.OpponentBg}>
