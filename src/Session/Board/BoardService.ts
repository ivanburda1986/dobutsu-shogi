...
export const listenToStonePositionChange = ({updateState, gameId}: StonePositionChangeListenerInterface) => {
...
const listenToGameStateChange = ({setWinner,setVictoryType, gameId}:GameStateChangeListenerInterface) => {
