...
export const getStones = ({ creatorId, oponentId, type }: { creatorId: string; oponentId: string; type: gameType }): StoneInterface[] => {
  if (type === "DOBUTSU") {
    return [
      ...
      { id: uuidv4(), type: "ELEPHANT", empowered: false, originalOwner: oponentId, currentOwner: oponentId, stashed: false, positionLetter: "C", positionNumber: 1 },
      { id: uuidv4(), type: "LION", empowered: false, originalOwner: oponentId, currentOwner: oponentId, stashed: false, positionLetter: "B", positionNumber: 1 },
      { id: uuidv4(), type: "GIRAFFE", empowered: false, originalOwner: oponentId, currentOwner: oponentId, stashed: false, positionLetter: "A", positionNumber: 1 },
      { id: uuidv4(), type: "CHICKEN", empowered: false, originalOwner: oponentId, currentOwner: oponentId, stashed: false, positionLetter: "B", positionNumber: 2 },
    ];
  } else
    return [
      { id: uuidv4(), type: "ELEPHANT", empowered: false, originalOwner: creatorId, currentOwner: creatorId, stashed: false, positionLetter: "A", positionNumber: 4 },
