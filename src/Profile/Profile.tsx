  ...
  return (
    <Container className="text-success">
                ...
                {["radio"].map(() => (
                  <div key={`inline-radio`} className="mb-3">
                    ...
                    <Form.Check
                      ...
                      label={<Avatar name="elephant" big />}
                      name="AvatarSelection"
                      type="radio"
                      id={`elephant`}
                      onChange={(e) => setSelectedAvatar(e.target.id)}
      ...
      {!isEditingProfile && (
        <Container
          fluid
          className="rounded py-1 my-1 mb-3 transparentContainer"
        >
          <Row>
            <Col className="d-flex flex-row justify-content-between align-items-center">
              <div className="d-flex flex-row justify-content-between align-items-center">
                <Avatar name={loggedInUserPhotoURL} big />
                <p className="fs-4 mx-2 align-middle my-auto">
